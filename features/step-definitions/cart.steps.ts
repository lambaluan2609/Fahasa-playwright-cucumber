 ...
 */
When('the user clicks the first product in the search results', async function (this: CustomWorld): Promise<void> {
 ...
 */
When('the user adds the product to the cart', async function (this: CustomWorld): Promise<void> {
  if (!this.page) throw new Error('Page not initialized');
 ...
 */
When('the user navigates to the cart page', async function (this: CustomWorld): Promise<void> {
  if (!this.page) throw new Error('Page not initialized');
 ...
 */
Then('the cart item name should not be empty', async function (this: CustomWorld): Promise<void> {
  if (!this.page) throw new Error('Page not initialized');
...
Then('the user selects the product in the cart', async function (this: CustomWorld): Promise<void> {
  if (!this.page) throw new Error('Page not initialized');
